...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'ros2_ws/src/eternal_description/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2_ws/install/eternal_description/share/eternal_description/config',
        robot_name
    )
...
def generate_launch_description():
    ...
    rviz_config_filename = 'eternal_description.rviz'
