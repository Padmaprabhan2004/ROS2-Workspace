#!/bin/bash
# bash script to launch with Gazebo and ROS 2 Controllers
...
#arena.sdf is the eternal warehouse world - use bot at z=0.4
...
ros2 launch eternal_gazebo eternal.gazebo.launch.py\
    enable_odom_tf:=true \
    headless:=True \
