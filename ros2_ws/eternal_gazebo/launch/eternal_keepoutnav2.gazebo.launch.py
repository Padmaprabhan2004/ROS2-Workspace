...
def generate_launch_description():
    ...
    declare_z_cmd = DeclareLaunchArgument('z', default_value='0.4')
    ...
    nav2_launch_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
            'use_sim_time': use_sim_time,
            'map': os.path.join(pkg_share_bringup, 'maps/arena.yaml'),
            'params_file': os.path.join(pkg_share_gazebo, 'params/nav2_params.yaml'),
    ...
    start_costmap_filter_info_server_cmd = Node(
        ...
        emulate_tty=True,
        parameters=[
            os.path.join(pkg_share_gazebo, 'params/costmap_filter_info.yaml'),
            {'use_sim_time': use_sim_time},
        ]
    )
